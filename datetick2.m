...
%   NOTE: It is often more convenient to plot datetime values using the desired
%   plotting function. Then you can format the tick labels using the xtickformat
%   and ytickformat functions. datetick is useful when plotting numeric values
%   that are serial date numbers.
%
...
%
%   See also DATETIME, DURATION, DATESTR, DATENUM, DATETIME, XTICKFORMAT, YTICKFORMAT, ZTICKFORMAT.
...
[labels,format] = dateTickPicker2(axh,[xmin,xmax],dateform,dateChoice,axVal);
